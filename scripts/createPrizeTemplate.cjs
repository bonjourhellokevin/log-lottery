    ...
    const templateData = [
        {
            ...
            [data.prizeConfigImageUrl]: 'https://example.com/image1.png',
        },
        {
            ...
            [data.prizeConfigImageUrl]: 'https://example.com/image2.png',
        },
        {
            ...
            [data.prizeConfigImageUrl]: 'https://example.com/image3.png',
        },
    ]
